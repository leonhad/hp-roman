 ...
 * The Roman8 charset.
 */
public class Roman9Charset extends AbstractCharset {
    ...
    private static final char[] TABLE = {
            ...
            '¯', 'Ý', 'ý', '°', 'Ç', 'ç', 'Ñ', 'ñ', '¡', '¿', '€', '£', '¥', '§', 'ƒ', '¢', // 0xB0
            'â', 'ê', 'ô', 'û', 'á', 'é', 'ó', 'ú', 'à', 'è', 'ò', 'ù', 'ä', 'ë', 'ö', 'ü', // 0xC0ƒ
     ...
     */
    public Roman9Charset() {
        super("roman9", new String[]{"hp-roman9", "HP_ROMAN9", "ROMAN9", "R9", "r9"});
    }
